...
function greetingByHour() {
  ...
  if (hour >= 12 && hour < 17) return 'Good Afternoon, Alex!'
  if (hour >= 17 && hour < 22) return 'Good Evening, Alex!'
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/40 p-6 backdrop-blur-xl">
      ...
      >
        ...
        <p className="mt-2 text-sm text-slate-300">Set your daily target before launching telemetry.</p>
        ...
        <button
          ...
          className="mt-7 w-full rounded-2xl bg-sky-400 px-5 py-3 text-base font-semibold text-slate-950 transition hover:bg-sky-300"
        >
          Launch Dashboard
        </button>
